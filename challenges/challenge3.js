 ...
 *    async / await will wait for the line to finish before running the next line. it returns a promise
 * 
 ...
 *  it will print out the values from the promise
 * 
  ...
  return await new Promise((res, rej) => {
    setTimeout(function() {
      if (typeof str === 'string') {
          ...
          rej('Argument to uppercaser must be string');
      }
      }, 500);
  })
}
